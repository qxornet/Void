...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->listBox1->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &New::listBox1_MouseMove);
			// 
			// listBox2
			// 
			...
			this->listBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &New::listBox2_SelectedIndexChanged);
			this->listBox2->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &New::listBox2_MouseMove);
			// 
			// label1
			// 
			...
			this->listBox3->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &New::listBox3_MouseMove);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &New::button4_Click);
			// 
			// label3
			// 
			...
			this->textBox1->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &New::textBox1_MouseMove);
			// 
			// panel1
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &New::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &New::button2_Click);
			// 
			// button1
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &New::textBox2_TextChanged);
			this->textBox2->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &New::textBox2_MouseMove);
			// 
			// openFileDialog1
			// 
			...
			// 
			this->folderBrowserDialog1->HelpRequest += gcnew System::EventHandler(this, &New::folderBrowserDialog1_HelpRequest);
			// 
			// saveFileDialog1
			// 
			...
			this->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &New::New_MouseMove);
...
private: System::Void New_MouseMove(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
