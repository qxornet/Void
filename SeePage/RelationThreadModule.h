...
namespace SeePage {
	...
	public ref class RelationThreadModule : public System::Windows::Forms::Form
	{
...
private: 
	...
	private: FastColoredTextBoxNS::FastColoredTextBox^  sqlCodeEditBox;
	...
	private: System::Windows::Forms::RichTextBox^  aboutSelectedBox;
	...
	private: System::Windows::Forms::ListView^  sqlFunctionList;
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(RelationThreadModule::typeid));
			System::Windows::Forms::DataGridViewCellStyle^  dataGridViewCellStyle1 = (gcnew System::Windows::Forms::DataGridViewCellStyle());
			System::Windows::Forms::DataGridViewCellStyle^  dataGridViewCellStyle2 = (gcnew System::Windows::Forms::DataGridViewCellStyle());
			System::Windows::Forms::ListViewGroup^  listViewGroup2 = (gcnew System::Windows::Forms::ListViewGroup(L"Ñòàíäàğòíûå", System::Windows::Forms::HorizontalAlignment::Left));
			System::Windows::Forms::ListViewGroup^  listViewGroup3 = (gcnew System::Windows::Forms::ListViewGroup(L"Ìàòåìàòè÷åñêèå ôóíêöèè", 
				System::Windows::Forms::HorizontalAlignment::Center));
			System::Windows::Forms::ListViewGroup^  listViewGroup4 = (gcnew System::Windows::Forms::ListViewGroup(L"Ñòğîêîâûå ôóíêöèè", System::Windows::Forms::HorizontalAlignment::Center));
			System::Windows::Forms::ListViewGroup^  listViewGroup5 = (gcnew System::Windows::Forms::ListViewGroup(L"Ñòàíäàğòíûå ôóíêöèè", System::Windows::Forms::HorizontalAlignment::Center));
			System::Windows::Forms::ListViewGroup^  listViewGroup6 = (gcnew System::Windows::Forms::ListViewGroup(L"Ôóíêöèè äàòèğîâîê", System::Windows::Forms::HorizontalAlignment::Center));
			System::Windows::Forms::ListViewGroup^  listViewGroup7 = (gcnew System::Windows::Forms::ListViewGroup(L"Ôóíêöèè ïğåîáğàçîâàíèÿ", 
				System::Windows::Forms::HorizontalAlignment::Center));
			...
			this->sqlCodeEditBox = (gcnew FastColoredTextBoxNS::FastColoredTextBox());
			...
			this->aboutSelectedBox = (gcnew System::Windows::Forms::RichTextBox());
			...
			this->sqlFunctionList = (gcnew System::Windows::Forms::ListView());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->sqlCodeEditBox))->BeginInit();
			...
			this->listView1->Click += gcnew System::EventHandler(this, &RelationThreadModule::listView1_Click);
			// 
			// tabControl1
			// 
			...
			// tabPage1
			// 
			this->tabPage1->Controls->Add(this->sqlCodeEditBox);
			...
			// sqlCodeEditBox
			// 
			this->sqlCodeEditBox->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Bottom) 
				| System::Windows::Forms::AnchorStyles::Left) 
				| System::Windows::Forms::AnchorStyles::Right));
			this->sqlCodeEditBox->AutoCompleteBracketsList = gcnew cli::array< System::Char >(10) {'(', ')', '{', '}', '[', ']', '\"', '\"', 
				'\'', '\''};
			this->sqlCodeEditBox->AutoIndentCharsPatterns = L"";
			this->sqlCodeEditBox->AutoScrollMinSize = System::Drawing::Size(27, 14);
			this->sqlCodeEditBox->BackBrush = nullptr;
			this->sqlCodeEditBox->CharHeight = 14;
			this->sqlCodeEditBox->CharWidth = 8;
			this->sqlCodeEditBox->CommentPrefix = L"--";
			this->sqlCodeEditBox->Cursor = System::Windows::Forms::Cursors::IBeam;
			this->sqlCodeEditBox->DisabledColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(100)), 
			...
			this->sqlCodeEditBox->Font = (gcnew System::Drawing::Font(L"Courier New", 9.75F));
			this->sqlCodeEditBox->IndentBackColor = System::Drawing::SystemColors::Window;
			this->sqlCodeEditBox->IsReplaceMode = false;
			this->sqlCodeEditBox->Language = FastColoredTextBoxNS::Language::SQL;
			this->sqlCodeEditBox->LeftBracket = '(';
			this->sqlCodeEditBox->LineNumberColor = System::Drawing::Color::Maroon;
			this->sqlCodeEditBox->Location = System::Drawing::Point(0, -1);
			this->sqlCodeEditBox->Name = L"sqlCodeEditBox";
			this->sqlCodeEditBox->Paddings = System::Windows::Forms::Padding(0);
			this->sqlCodeEditBox->RightBracket = ')';
			this->sqlCodeEditBox->SelectionColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(60)), 
			...
			this->sqlCodeEditBox->ServiceColors = (cli::safe_cast<FastColoredTextBoxNS::ServiceColors^  >(resources->GetObject(L"sqlCodeEditBox.ServiceColors")));
			this->sqlCodeEditBox->ServiceLinesColor = System::Drawing::Color::Maroon;
			this->sqlCodeEditBox->Size = System::Drawing::Size(368, 380);
			this->sqlCodeEditBox->TabIndex = 0;
			this->sqlCodeEditBox->Zoom = 100;
			// 
			// tabPage2
			// 
			...
			this->panel1->DoubleClick += gcnew System::EventHandler(this, &RelationThreadModule::panel1_DoubleClick);
			// 
			// toolStrip1
			// 
			...
			this->îòêğûòüToolStripButton->Click += gcnew System::EventHandler(this, &RelationThreadModule::îòêğûòüToolStripButton_Click);
			// 
			...
			this->toolStripButton1->Click += gcnew System::EventHandler(this, &RelationThreadModule::toolStripButton1_Click);
			// 
			...
			this->panel2->Controls->Add(this->aboutSelectedBox);
			...
			// aboutSelectedBox
			// 
			this->aboutSelectedBox->BorderStyle = System::Windows::Forms::BorderStyle::None;
			this->aboutSelectedBox->Dock = System::Windows::Forms::DockStyle::Fill;
			this->aboutSelectedBox->Location = System::Drawing::Point(0, 0);
			this->aboutSelectedBox->Name = L"aboutSelectedBox";
			this->aboutSelectedBox->Size = System::Drawing::Size(210, 97);
			this->aboutSelectedBox->TabIndex = 0;
			this->aboutSelectedBox->Text = L"";
			// 
			// label5
			// 
			...
			this->dataGridView4->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &RelationThreadModule::dataGridView4_CellContentClick);
			// 
			// Column16
			// 
			...
			// tabPage6
			// 
			this->tabPage6->Controls->Add(this->sqlFunctionList);
			...
			// sqlFunctionList
			// 
			this->sqlFunctionList->Activation = System::Windows::Forms::ItemActivation::OneClick;
			this->sqlFunctionList->BackColor = System::Drawing::SystemColors::ControlLightLight;
			this->sqlFunctionList->BorderStyle = System::Windows::Forms::BorderStyle::None;
			this->sqlFunctionList->Dock = System::Windows::Forms::DockStyle::Fill;
			this->sqlFunctionList->ForeColor = System::Drawing::SystemColors::WindowText;
			listViewGroup2->Header = L"Ñòàíäàğòíûå";
			listViewGroup2->Name = L"listViewGroup4";
			listViewGroup3->Header = L"Ìàòåìàòè÷åñêèå ôóíêöèè";
			listViewGroup3->HeaderAlignment = System::Windows::Forms::HorizontalAlignment::Center;
			listViewGroup3->Name = L"math";
			listViewGroup4->Header = L"Ñòğîêîâûå ôóíêöèè";
			listViewGroup4->HeaderAlignment = System::Windows::Forms::HorizontalAlignment::Center;
			listViewGroup4->Name = L"listViewGroup1";
			listViewGroup5->Header = L"Ñòàíäàğòíûå ôóíêöèè";
			listViewGroup5->HeaderAlignment = System::Windows::Forms::HorizontalAlignment::Center;
			listViewGroup5->Name = L"listViewGroup2";
			listViewGroup6->Header = L"Ôóíêöèè äàòèğîâîê";
			listViewGroup6->HeaderAlignment = System::Windows::Forms::HorizontalAlignment::Center;
			listViewGroup6->Name = L"listViewGroup3";
			listViewGroup7->Header = L"Ôóíêöèè ïğåîáğàçîâàíèÿ";
			listViewGroup7->HeaderAlignment = System::Windows::Forms::HorizontalAlignment::Center;
			listViewGroup7->Name = L"listViewGroup5";
			this->sqlFunctionList->Groups->AddRange(gcnew cli::array< System::Windows::Forms::ListViewGroup^  >(6) {listViewGroup2, listViewGroup3, 
				listViewGroup4, listViewGroup5, listViewGroup6, listViewGroup7});
			this->sqlFunctionList->HeaderStyle = System::Windows::Forms::ColumnHeaderStyle::Nonclickable;
			this->sqlFunctionList->HotTracking = true;
			this->sqlFunctionList->HoverSelection = true;
			...
			this->sqlFunctionList->Items->AddRange(gcnew cli::array< System::Windows::Forms::ListViewItem^  >(34) {listViewItem6, listViewItem7, 
			...
			this->sqlFunctionList->LabelEdit = true;
			this->sqlFunctionList->Location = System::Drawing::Point(3, 3);
			this->sqlFunctionList->Name = L"sqlFunctionList";
			this->sqlFunctionList->Size = System::Drawing::Size(199, 394);
			this->sqlFunctionList->TabIndex = 1;
			this->sqlFunctionList->UseCompatibleStateImageBehavior = false;
			this->sqlFunctionList->View = System::Windows::Forms::View::SmallIcon;
			this->sqlFunctionList->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &RelationThreadModule::listView2_MouseClick);
			// 
			// tabPage7
			// 
			...
			this->ïğîåêòToolStripMenuItem->Click += gcnew System::EventHandler(this, &RelationThreadModule::ïğîåêòToolStripMenuItem_Click);
			// 
			...
			this->toolStripMenuItem7->Size = System::Drawing::Size(205, 22);
			...
			this->toolStripMenuItem20->Size = System::Drawing::Size(205, 22);
			...
			this->toolStripMenuItem21->Size = System::Drawing::Size(103, 22);
			this->toolStripMenuItem21->Text = L"Òåêñò";
			// 
			// toolStripMenuItem22
			// 
			this->toolStripMenuItem22->Name = L"toolStripMenuItem22";
			this->toolStripMenuItem22->Size = System::Drawing::Size(103, 22);
			...
			this->ìåíåäæåğÏğîåêòîâToolStripMenuItem->Click += gcnew System::EventHandler(this, &RelationThreadModule::ìåíåäæåğÏğîåêòîâToolStripMenuItem_Click);
			// 
			...
			this->ïîêàçàòüÈñòî÷íèêèÄàííûõToolStripMenuItem->Size = System::Drawing::Size(230, 22);
			...
			this->ñïèñîêÍàéäåííûõÄàííûõToolStripMenuItem->Size = System::Drawing::Size(230, 22);
			...
			this->äîáàâèòüÄàííûåToolStripMenuItem->Size = System::Drawing::Size(230, 22);
			...
			this->íàéòèÄàííûåÂÈíòåğíåòåToolStripMenuItem->Size = System::Drawing::Size(230, 22);
			...
			this->Name = L"RelationThreadModule";
			this->Text = L"Relation Thread";
			this->TransparencyKey = System::Drawing::Color::Red;
			this->tabControl1->ResumeLayout(false);
			this->tabPage1->ResumeLayout(false);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->sqlCodeEditBox))->EndInit();
